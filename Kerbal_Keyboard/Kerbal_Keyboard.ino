...
void loop()
{
  ...
  //Joystick.button(1, digitalRead(brakes));        //Moved Joystick code to a second .ino to be used on second Teensy
  //delay(50);
...
//if (digitalRead(brakes) == LOW)             //Not used due to lakcing toggle behavior        
//{Keyboard.press('b');}
//else
//{Keyboard.release('b');}
